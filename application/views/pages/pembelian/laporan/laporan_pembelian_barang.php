    ...
    <div class="col-md-12">
        ...
        <div class="box box-solid bg-green-gradient">
            <div class="box-header">
                ...
                <h3 class="box-title">List Pembelian Spare Part</h3>
            </div>
            <!-- /.box-header -->
                    ...
                    <table id="example2" class="table table-bordered table-striped">
                        ...
                        <?php $i=1;  foreach ($transaksi->result() as $key => $value){?>
                            <tr>
                                ...
                                <td>
                                    <a title="Lihat Detail" class="btn btn-flat btn-success btn-xs" href="<?= site_url('add_pembelian_barang/'.$value->kode_pembelian)?>"><?=$value->kode_pembelian;?></a>
                                </td>
                            </tr>
                        <?php }?>
                        </tbody>
