...
<div class="row">
    <div class="col-md-4">
        <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post"  action="javascript:void(0)" id="form_edit_kategori_barang" onsubmit="edit_kategori_barang()">
                <div class="box-body">

                    <div class="form-group">
                        <div class="col-sm-12">
                            <label >Kode <?=$subtitle?></label>
                            <input type="text" readonly="readonly" class="form-control" name="kode" value="<?=$kategori_barang->kode_kategori;?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control" name="nama" id="nama" required="required" value="<?=$kategori_barang->nama_kategori;?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="keterangan" class="form-control" value="<?=$kategori_barang->keterangan_kategori?>">
                        </div>
                    </div>
                ...
                <div class="box-footer">
                    <a href="<?= site_url('master/jenis_'.$jenis.'.php')?>" type="button" class="btn btn-default">Batal</a>
...
<script>
    ...
    function edit_kategori_barang() {
        $.ajax({
            url : "<?=site_url('master/edit_jenis_'.$jenis.'.do')?>",
            data: $('#form_edit_kategori_barang').serialize(),
            type: 'POST',
